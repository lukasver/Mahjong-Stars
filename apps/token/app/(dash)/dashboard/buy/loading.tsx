      ...
      <div className='container mx-auto px-4 py-8'>
        ...
        <div className='text-center mb-8'>
          <div className='flex items-center justify-center gap-2 mb-4'>
            <Skeleton className='h-8 w-8 rounded-full bg-secondary-500' />
            <Skeleton className='h-10 w-64 bg-secondary-500' />
          </div>
          <Skeleton className='h-6 w-96 mx-auto bg-secondary-500' />
        </div>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-3 gap-8'>
            ...
            <Card className='bg-secondary-800/50 border-secondary-700'>
              <CardContent className='p-0'>
                ...
                <div className='relative'>
                  <Skeleton className='w-full h-64 bg-secondary-500' />
                </div>

                {/* Tabs Loading */}
                <div className='p-6'>
                  <div className='flex space-x-1 mb-6'>
                    <Skeleton className='h-10 w-32 bg-secondary-600' />
                  ...
                  <div className='space-y-4'>
                    {Array.from({ length: 5 }).map((_, index) => (
                      <div
                        key={index}
                        className='border-b border-secondary-600 pb-4'
                      >
                        <div className='flex items-center justify-between mb-3'>
                          <Skeleton className='h-6 w-48 bg-secondary-600' />
                          <Skeleton className='h-4 w-4 bg-secondary-600' />
                        </div>
                        {index === 0 && (
                          <div className='space-y-2'>
                            ...
                            <div className='mt-4 space-y-2'>
                              <Skeleton className='h-4 w-full bg-secondary-500' />
                              <Skeleton className='h-4 w-full bg-secondary-500' />
                              <Skeleton className='h-4 w-5/6 bg-secondary-500' />
                            </div>
                            <div className='mt-4 space-y-2'>
                              <Skeleton className='h-4 w-full bg-secondary-500' />
                              <Skeleton className='h-4 w-2/3 bg-secondary-500' />
                            </div>
                          </div>
                        )}
                      </div>
          ...
          <div className='lg:col-span-1 space-y-6'>
            ...
            <Card className='bg-secondary-800/50 border-secondary-700'>
              <CardHeader>
                <Skeleton className='h-7 w-24 bg-secondary-600' />
              </CardHeader>
              <CardContent className='space-y-4'>
                {/* Tokens Available */}
                <div className='flex justify-between items-center'>
                  <Skeleton className='h-4 w-32 bg-secondary-500' />
                  <Skeleton className='h-4 w-20 bg-secondary-600' />
                </div>
                ...
                <div className='space-y-2'>
                  ...
                  <div className='flex justify-between'>
                    <Skeleton className='h-3 w-20 bg-secondary-500' />
                    <Skeleton className='h-3 w-16 bg-secondary-500' />
                  </div>
                </div>
                ...
                <div className='space-y-3 pt-4'>
                  {[
                    ...
                    >
                      ...
                      <Skeleton
                        className={`h-4 ${item.width} bg-secondary-600`}
                      />
                    </div>
                  ))}
                </div>
            ...
            <Card className='bg-secondary-800/50 border-secondary-700'>
              <CardHeader>
                <Skeleton className='h-7 w-16 bg-secondary-600' />
              </CardHeader>
              <CardContent className='space-y-4'>
                {/* Wallet Address */}
                <div className='space-y-2'>
                  <Skeleton className='h-4 w-28 bg-secondary-500' />
                ...
                {/* Purchase Button */}
                <Skeleton className='h-12 w-full bg-secondary-600 mt-6' />
              </CardContent>
            </Card>
          </div>
        </div>
