...
import { Card, CardContent, CardDescription, CardFooter, CardHeader, CardTitle } from "@mjs/ui/primitives/card";
...
export default function PaymentMethodSelector({
  ...
  const initialMethod = allowedMethods && !allowedMethods.includes(defaultMethod)
  ...
  const FooterComponent = () => {
    return (<Button
      ...
      className="w-full bg-white hover:bg-gray-100 text-black font-semibold rounded-xl text-base transition-all shadow-lg hover:shadow-xl"
    >
...
const CardWrapper = ({ children, asCard, footer }: { children: React.ReactNode, asCard: boolean, footer?: React.ReactNode }) => {
  return !asCard ? children : (
    <Card
    ...
    >
      ...
      {/* Header */}
      <CardHeader>
        <CardTitle><h2 className="text-3xl font-bold text-white mb-2">Payment</h2></CardTitle>
